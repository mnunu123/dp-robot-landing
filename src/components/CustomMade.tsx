  ...
  return (
    ...
    <section className="section-mobile min-h-screen relative overflow-hidden bg-black">
      ...
      <motion.div className="text-center mb-12" {...fadeInUp}>
        <p className="mb-8 font-cafe24 text-[16px] leading-[1.7] text-white text-readable mx-auto">
          "해외 사례 속 그 독보적인 움직임, 그대로 가져오고 싶으셨나요?<br />
          상상하시던 디자인과 기능을 그대로"
        </p>
        </motion.div>
      </div>
      ...
      <motion.div className="text-center mb-12" {...fadeInUp}>
        <p className="mb-8 font-cafe24 text-[22px] leading-[1.7] text-white text-readable mx-auto">
          "귀하의 비즈니스 환경에 최적화하여<br />
          <span className="text-[#ff6262] text-[22px] font-bold">맞춤 제작</span>합니다."
        </p>
        </motion.div>
      </div>
